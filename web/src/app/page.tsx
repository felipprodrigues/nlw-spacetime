  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex  flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/stars.svg)] bg-cover px-28 py-16 ">
        {/* Blur */}
        <div className="absolute right-0 top-1/2 h-[288px] w-[586px] -translate-y-1/2 translate-x-1/2 rounded-full bg-purple-700 opacity-50 blur-full"></div>
        {/* Stripes */}
        ...
        <div className="space-y-5">
          ...
          <div className="max-w-[420px] space-y-1">
            ...
            <p className="text-lg leading-relaxed">
              Coleciona momentos marcantes da sua jornada e compartilhe (se
              quiser) com o mundo
            </p>
